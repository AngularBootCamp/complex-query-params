# Angular Boot Camp example: complex-query-params
...
**[StackBlitz for complex-query-params](https://stackblitz.io/github/AngularBootCamp/complex-query-params)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/complex-query-params.git
cd complex-query-params
npm install
npm start
```
